  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 font-sans selection:bg-slate-800 selection:text-white flex flex-col justify-between">
      ...
      <main className="max-w-xl w-full mx-auto px-6 pt-16 pb-12 grow flex flex-col justify-center">
        ...
        <div className="bg-linear-to-b from-slate-950 to-black border border-slate-900 rounded-2xl p-6 sm:p-8 shadow-2xl relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 h-px bg-linear-to-r from-transparent via-blue-500/50 to-transparent" />
